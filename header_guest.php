				...
				<div class="container">
					<div class="header-row justify-content-lg-between">
						...
						<div class="header-misc col-xl-5 col-lg justify-content-end ms-auto d-none d-md-flex">
							...
							<a href="login.php" class="button-gaming text-larger font-primary all-ts fw-bold me-3 no-modal"><span class="button-span-text ">Log-in</span></a>
						</div>
